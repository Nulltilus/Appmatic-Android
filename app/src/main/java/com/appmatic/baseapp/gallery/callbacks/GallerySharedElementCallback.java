package com.appmatic.baseapp.gallery.callbacks;
...
public class GallerySharedElementCallback extends SharedElementCallback {

    private final List<View> mSharedElementViews;

    public GallerySharedElementCallback() {
