...
public class AppmaticUtils {
    ...
    public static View parseContent(@NonNull final Context context, final Content content, boolean isFirstView, boolean isLastView) {
        ...
        switch (content.getType()) {
            ...
            case Content.TYPE_IMAGE:
                ...
                ((ImageView) newView).setScaleType(ScaleType.CENTER_CROP);
            ...
            case Content.TYPE_YOUTUBE:
                ...
                youTubeThumbnailView.setScaleType(ScaleType.CENTER_CROP);
                youTubeThumbnailView.setAdjustViewBounds(true); // As seen in http://stackoverflow.com/a/23550010

                LayoutParams thumbnailParams = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
                ...
                LayoutParams frameLayoutParams = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
    ...
    private static void setViewMargins(View view, int start, int top, int end, int bottom) {
        ((LayoutParams) view.getLayoutParams()).setMargins(start, top, end, bottom);
    }

    private static LayoutParams injectFrameLayoutMargins(LayoutParams layoutParams, int start, int top, int end, int bottom) {
